...
(function (g, k) {
    ...
    function n(a, c, e) {
        a.parentNode
            ? a.parentNode.parentNode || c.appendChild(a.parentNode)
            : c.appendChild(a);
    ...
    l.prototype = {
        ...
        off: function (a, c) {
            this._events = this._events || {};
            !1 !== a in this._events &&
                this._events[a].splice(this._events[a].indexOf(c), 1);
        },
        emit: function (a) {
            this._events = this._events || {};
            if (!1 !== a in this._events)
                for (var c = 0; c < this._events[a].length; c++)
                    this._events[a][c].apply(
                        this,
    ...
    l.mixin = function (a) {
        for (var c = ["on", "off", "emit"], b = 0; b < c.length; b++)
            "function" === typeof a
                ? (a.prototype[c[b]] = l.prototype[c[b]])
                : (a[c[b]] = l.prototype[c[b]]);
        return a;
    };
    var b = {
            extend: function (a, c) {
            ...
            addClass: function (a, c) {
                b.hasClass(a, c) ||
                    (a.classList
                        ? a.classList.add(c)
                        : (a.className = a.className.trim() + " " + c));
            },
            ...
            closest: function (a, c) {
                return (
                    a &&
                    a !== document.body &&
                    (c(a) ? a : b.closest(a.parentNode, c))
                );
            },
            isInt: function (a) {
                return (
        ...
        p = function () {
            if (this.items.length) {
                ...
                a.childElementCount &&
                    ...
                    (this.navIndex = (
                        a.querySelector(".selectr-option.selected") ||
                        a.querySelector(".selectr-option")
                    ).idx),
        ...
        m = function (a, c) {
            var e = this.customOption
                ? this.config.renderOption(c || a)
                : a.textContent;
        ...
        u = function () {
            ...
            k(this.config, "width") &&
                (b.isInt(this.config.width)
                    ...
                    : "auto" === this.config.width
                      ? (this.width = "100%")
                      : b.includes(this.config.width, "%") &&
                        (this.width = this.config.width));
            this.container = b.createElement("div", {
                class: "selectr-container",
            });
            this.config.customClass &&
                b.addClass(this.container, this.config.customClass);
            this.mobileDevice
            ...
            this.config.clearable &&
                ((this.selectClear = b.createElement("button", {
                    class: "selectr-clear",
                    type: "button",
                })),
        ...
        v = function (a) {
            ...
            if (
                ...
                d
                    ...
                    : 0 === this.navIndex
                      ? (this.tree.scrollTop = 0)
                      : 0 > a.top - this.optsRect.top &&
                        (this.tree.scrollTop += a.top - this.optsRect.top);
        ...
        w = function (a) {
            ...
            f = this.customSelected
                ? this.config.renderSelection(f)
                : d.textContent;
            ...
            if (this.config.sortSelected) {
                ...
                a.sort(function (a, b) {
                    ...
                    if (!0 === c.config.sortSelected) {
                        ...
                        "text" === c.config.sortSelected &&
                            ((f = a.textContent), (h = b.textContent));
                    g(f, d);
                    for (g(h, e); d.length && e.length; )
                        if (
                            ((f = d.shift()),
                            (h = e.shift()),
                            (f = f[0] - h[0] || f[1].localeCompare(h[1])))
                        )
                            return f;
            ...
            this.config.taggable
                ? this.label.insertBefore(e, this.input.parentNode)
        ...
        q = function () {
            if (this.config.searchable || this.config.taggable)
                ((this.input.value = null),
                    (this.searching = !1),
                    this.config.searchable &&
                        b.removeClass(this.inputContainer, "active"),
    ...
    g.prototype.bindEvents = function () {
        ...
        if (this.config.nativeKeyboard) {
            ...
            this.selected.addEventListener("keydown", function (b) {
                if (
                    ...
                    if (
                        ...
                        (!a.opened &&
                            -1 <
                                ["Enter", "ArrowUp", "ArrowDown"].indexOf(
                                    b.key,
                                ))
                    )
            ...
            this.container.addEventListener("keyup", function (b) {
                a.opened &&
                    "Escape" === b.key &&
                    (a.close(), b.stopPropagation(), a.selected.focus());
            });
        }
        this.label.addEventListener("click", function (c) {
            b.hasClass(c.target, "selectr-tag-remove") &&
                a.deselect(c.target.parentNode.idx);
        });
        this.selectClear &&
        ...
        this.tree.addEventListener("click", function (c) {
            ...
            d &&
                ...
                (b.hasClass(d, "selected")
                    ? (a.el.multiple ||
                          (!a.el.multiple && a.config.allowDeselect)) &&
                      a.deselect(d.idx)
                    : a.select(d.idx),
                    ...
                    if (13 === c.which || b.includes(a.tagSeperators, c.key))
                        (b.each(a.tagSeperators, function (a, b) {
                            ...
                            a.add({ value: d, text: d, selected: !0 }, !0)
                                ...
                                : ((this.value = ""),
                                  a.setMessage(
                                      a.config.messages.tagDuplicate,
                                  )));
                }
            });
    ...
    g.prototype.change = function (a) {
        var c = this.items[a],
            e = this.options[a];
        e.disabled ||
            (e.selected && b.hasClass(c, "selected")
                ? this.deselect(a)
                : this.select(a),
    ...
    g.prototype.setValue = function (a) {
        ...
        b.each(
            this.options,
            function (b, d) {
                ((c && -1 < a.indexOf(d.value)) || d.value === a) &&
                    this.change(d.idx);
            },
            this,
        );
            ...
            if (Array.isArray(a))
                ...
                if (c) {
                    ...
                    b.each(this.options, function (b, c) {
                        c.value.toLowerCase() === a.value.toLowerCase() &&
                            (e = !0);
                    });
                    if (e) return !1;
                }
            ...
            ? b.each(
                  ...
                  function (a, e) {
                      b.isInt(e)
                          ...
                          : "string" === typeof e &&
                            c.push(this.getOptionByValue(e));
                  },
                  this,
              )
            : b.isInt(a)
            ...
            if (0 < a.length) {
                ...
                b.each(
                    ...
                    function (c, h) {
                        ...
                        if (
                            g(h.textContent.trim().toLowerCase(), a) &&
                            !h.disabled
                        ) {
                            if (
                                (d.push({
                                ...
                                e &&
                                    (n(k, f, this.customOption),
                                    b.removeClass(k, "excluded"),
                                    !this.customOption))
                            ) {
                                var l = (l = new RegExp(a, "i").exec(
                                    h.textContent,
                                ))
                                    ? h.textContent.replace(
                                          l[0],
                                          "<span class='selectr-match'>" +
                                              l[0] +
                                              "</span>",
                                      )
                                    : !1;
    ...
    g.prototype.paginate = function () {
        if (this.items.length) {
            ...
            return (this.pages = this.items
                .map(function (b, e) {
                    return 0 === e % a.config.pagination
                        ? a.items.slice(e, e + a.config.pagination)
                        : null;
                })
                .filter(function (a) {
                    return a;
    ...
    g.prototype.invert = function () {
        ...
        a.top + a.height + this.tree.parentNode.offsetHeight >
        window.innerHeight
            ? (b.addClass(this.container, "inverted"), (this.isInverted = !0))
            : (b.removeClass(this.container, "inverted"),
              (this.isInverted = !1));
        this.optsRect = b.rect(this.tree);
    };
