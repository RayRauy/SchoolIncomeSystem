...
<head>
    ...
    <title>Overseas | School - Admin & Dashboard</title>
...
<!-- vendor js -->
    ...
    <script src="{{  asset('template/assets/data/stock-prices.js') }}"></script>
    <script src="{{  asset('template/assets/libs/jsvectormap/js/jsvectormap.min.js') }}"></script>
    <script src="{{  asset('template/assets/libs/jsvectormap/maps/world.js') }}"></script>
    <script src="{{  asset('template/assets/js/pages/index.init.js') }}"></script>
